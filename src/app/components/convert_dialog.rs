...
fn init_layout_list_factory(layout_guard: &mut FactoryVecDequeGuard<LayoutModel>) {
    ...
    layout_guard.push_back(
        Layout::new(
            "/com/github/forensicht/Dompeg/images/layout_2x2.png".to_string(), 
            LayoutType::L2x2,
        ));
    layout_guard.push_back(
        Layout::new(
            "/com/github/forensicht/Dompeg/images/layout_2x3.png".to_string(), 
            LayoutType::L2x3,
        ));
    layout_guard.push_back(
        Layout::new(
            "/com/github/forensicht/Dompeg/images/layout_2x4.png".to_string(), 
            LayoutType::L2x4,
        ));
    layout_guard.push_back(
        Layout::new(
            "/com/github/forensicht/Dompeg/images/layout_3x2.png".to_string(), 
            LayoutType::L3x2,
        ));
    layout_guard.push_back(
        Layout::new(
            "/com/github/forensicht/Dompeg/images/layout_3x3.png".to_string(), 
            LayoutType::L3x3,
        ));
    layout_guard.push_back(
        Layout::new(
            "/com/github/forensicht/Dompeg/images/layout_3x4.png".to_string(), 
            LayoutType::L3x4,
        ));
    layout_guard.push_back(
        Layout::new(
            "/com/github/forensicht/Dompeg/images/layout_4x2.png".to_string(), 
            LayoutType::L4x2,
        ));
    layout_guard.push_back(
        Layout::new(
            "/com/github/forensicht/Dompeg/images/layout_4x3.png".to_string(), 
            LayoutType::L4x3,
        ));
    layout_guard.push_back(
        Layout::new(
            "/com/github/forensicht/Dompeg/images/layout_4x4.png".to_string(), 
            LayoutType::L4x4,
        ));
    layout_guard.push_back(
        Layout::new(
            "/com/github/forensicht/Dompeg/images/layout_4x5.png".to_string(), 
            LayoutType::L4x5,
        ));
    layout_guard.push_back(
        Layout::new(
            "/com/github/forensicht/Dompeg/images/layout_5x4.png".to_string(), 
            LayoutType::L5x4,
        ));
    layout_guard.push_back(
        Layout::new(
            "/com/github/forensicht/Dompeg/images/layout_5x5.png".to_string(), 
            LayoutType::L5x5,
        ));
    layout_guard.push_back(
        Layout::new(
            "/com/github/forensicht/Dompeg/images/layout_6x6.png".to_string(), 
            LayoutType::L6x6,
        ));
    layout_guard.push_back(
        Layout::new(
            "/com/github/forensicht/Dompeg/images/layout_8x8.png".to_string(), 
            LayoutType::L8x8,
        ));
    layout_guard.push_back(
        Layout::new(
            "/com/github/forensicht/Dompeg/images/layout_10x10.png".to_string(), 
            LayoutType::L10x10,
        ));
}
